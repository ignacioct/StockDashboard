...
def main() -> None:
    ...
    st.markdown("<h4 style='text-align: center;'>A Web App by <a href=https://github.com/ignacioct>Ignacio Talavera</a></h4>", unsafe_allow_html=True)
    ...
    firstCol.dataframe(portfolio.df)
